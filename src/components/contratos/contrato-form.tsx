...
export function ContratoForm({ 
  ...
  const form = useForm<ContratoFormValues>({
    ...
    defaultValues: {
      fecha_inicio: format(new Date(contrato.contract.fecha_inicio), 'yyyy-MM-dd'),
      ...
      estado: contrato.contract.estado,
  ...
  const onSubmit = async (data: ContratoFormValues) => {
    try {
      await actualizarContrato({
        ...
        fecha_final: data.fecha_final ? new Date(data.fecha_final).toISOString() : undefined,
      });
